...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in [Conv, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv, MixConv2d, Focus, CrossConv, BottleneckCSP,
            ...
            c2 = c1 // 2
            args = [c1, c2, *args]
        elif m is DAM:  # 2024/10/20 wwc 修改
            c2 = ch[f[0]]
            args = [c2, *args[1:]]
        elif m is FFM:  # 2024/10/20 wwc 修改
            c2 = ch[f]
            args = [c2, *args[1:]]
        # 2024/10/24 added by wwc
        else:
            c2 = ch[f]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='./data/multispectral/FLIR.yaml', help='model.yaml')
