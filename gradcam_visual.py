...
parser.add_argument('--output-dir', type=str, default='./dataset/FLIR-align-3class/Grad_CAM_visual/outputs_nin_head', help='output dir')
...
if __name__ == '__main__':
    if os.path.isdir(args.source1):
        ...
        for item in img_vis_list[1127:]:
            ...
            if args.source1 == './dataset/FLIR-align-3class/visible/test':
